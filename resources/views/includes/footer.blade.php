<footer id="main-footer">
    <div class="container">
        <div class="row">
            <div class="col md-6">
                <h6>Social Media</h6>
                    <a href="https://www.facebook.com/SHDFamily1" target="_blank"><span class="fa fa-facebook"></span> </a>
                    <a href="https://twitter.com/SHD_FAMILY" target="_blank"><span class="fa fa-twitter"></span> </a>
                    <a href="https://www.youtube.com/channel/UC5VgYHJqshHgS6Gtj2kLspw/featured" target="_blank"><span class="fa fa-youtube"></span> </a>
            </div>
